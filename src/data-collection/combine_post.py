...
def combine_csv_files(first_file, main_file, output_file):
    ...
    print(f"Initial counts: {initial_count_first} records in first file, {initial_count_main} records in main file")
...
def main():
    ...
    print(f"Cat files combined successfully!")
    print(f"Initial counts: {cat_stats['initial_count_first']} (first) + {cat_stats['initial_count_main']} (main)")
    ...
    print(f"Dog files combined successfully!")
    print(f"Initial counts: {dog_stats['initial_count_first']} (first) + {dog_stats['initial_count_main']} (main)")
